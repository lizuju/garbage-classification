...
> [!IMPORTANT]
> 模型训练与数据集仓库：[lizuju/garbage265](https://github.com/lizuju/garbage265)。
...
![垃圾分类识别系统首页](docs/assets/garbage-classification-home.png)
...
> 训练过程经过 **80 次实验迭代**（exp ~ exp80），最终产出的 `best.pt`（~90MB）为系统当前使用的生产权重。
